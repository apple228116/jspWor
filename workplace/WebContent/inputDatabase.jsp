...
<jsp:useBean id="recordBean" class="myservlet.control.Shiyan1_Bean" scope="session"/>
<HTML><body bgcolor=yellow><font size=2>
<form action="shiyan1Servlet" method=post>
<b>数据库:<input type="text" name="dataBase" size=22 value =tset>
<br>表名：<input type="text" name="tableName" size=23 value=SB>
<br>用户名(默认root)：<input type="text" name="user" size=10 value=root>
<br>用户密码(默认空)：<input type="text" name="password" size=10 value=123456>
